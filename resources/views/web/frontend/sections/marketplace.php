    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="etl-single-marketplace">
                    <div class="etl-marketplace-left">
                        <img src="assets/images/marketplace/fiverr.png" alt="fiverr">
                        <h5>Fiverr</h5>
                    </div>
                    <div class="etl-marketplace-right">
                        <h2>Fiverr Market Place related topic title</h2>
                        <p>Odit labore dignissimos quia corporis, inventore mollitia, similique ea voluptas, odio eligendi ducimus aliquam quam, nulla explicabo blanditiis in facere nemo? Dicta.</p>
            ...
            <div class="col-md-12">
                <div class="etl-single-marketplace">
                    <div class="etl-marketplace-left">
                        <img src="assets/images/marketplace/upwork.jpg" alt="Upwork">
                        <h5>Upwork</h5>
                    </div>
                    <div class="etl-marketplace-right">
            ...
            <div class="col-md-12">
                <div class="etl-single-marketplace">
                    <div class="etl-marketplace-left">
                        <img src="assets/images/marketplace/freelancer.png" alt="freelancer">
                        <h5>Freelancer</h5>
                    </div>
                    <div class="etl-marketplace-right">
            ...
            <div class="col-md-12">
                <div class="etl-single-marketplace">
                    <div class="etl-marketplace-left">
                        <img src="assets/images/marketplace/peopleperhour.png" alt="PeoplePerHour">
                        <h5>PeoplePerHour</h5>
                    </div>
                    <div class="etl-marketplace-right">
