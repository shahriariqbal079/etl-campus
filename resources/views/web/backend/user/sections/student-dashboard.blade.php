                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            <div class="chart" style="height: 128px;">
                                <canvas id="iqChart" class="chart-canvas js-update-chart-line" data-chart-hide-axes="false"
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                ...
                                <a class="card border-0 mb-0" href="">
                                    <img src="../../public/images/achievements/flinto.png" alt="Flinto" class="card-img"
                                            ...
                                            <span class="col d-flex flex-column">
                                                <span>
                                                    <span class="card-title text-white mb-4pt d-block">Angular
                                                        fundamentals</span>
                                                    <span class="text-white-60">Creating and Communicating Between Angular
                                                        Components</span>
                                                </span>
                                            </span>
                                        </span>
            ...
            <div class="row mb-lg-16pt">
                <div class="col-lg-6 mb-8pt mb-sm-0">
                                ...
                                <div class="flex">
                                    <div class="d-flex align-items-center">
                                        <div class="rounded mr-12pt z-0 o-hidden">
                                            <div class="overlay">
                                                <img src="../../public/images/paths/angular_40x40@2x.png" width="40"
                    ...
                    <div class="popoverContainer d-none">
                        ...
                        <p class="mt-16pt text-70">Learn the fundamentals of working with Angular and how to create basic
                            applications.</p>
                    ...
                    <div class="popoverContainer d-none">
                        <div class="media">
                            <div class="media-left mr-12pt">
                                <img src="../../public/images/paths/swift_40x40@2x.png" width="40" height="40" alt="Angular"
                                    class="rounded">
                            </div>
                            <div class="media-body">
                                <div class="card-title">Swift</div>
                    ...
                    <div class="popoverContainer d-none">
                        <div class="media">
                            <div class="media-left mr-12pt">
                                <img src="../../public/images/paths/react_40x40@2x.png" width="40" height="40" alt="Angular"
                                    class="rounded">
                            </div>
                            <div class="media-body">
                                <div class="card-title">React Native</div>
                                    ...
                                    <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay mdk-reveal js-mdk-reveal "
                                        ...
                                        <div class="mdk-reveal__content">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="flex">
                                                        <a class="card-title" href="student-take-course.html">Build a
                                                            WordPress Website</a>
                                                        <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                                    </div>
                                                    <a href="student-take-course.html" data-toggle="tooltip"
            ...
            <div class="row card-group-row">
                    ...
                    <div class="card card-group-row__card card-sm">
                        <div class="card-body d-flex align-items-center">
                            <a href="student-take-quiz.html" class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
                                <img src="../../public/images/paths/typescript_200x168.png" alt="Introduction to TypeScript"
                                    class="avatar-img rounded">
                                <span class="overlay__content"></span>
                            </a>
                            <div class="flex mr-12pt">
                                <a class="card-title" href="student-take-quiz.html">Introduction to TypeScript</a>
                ...
                <div class="card-group-row__col col-md-6">
                    ...
                    <div class="card card-group-row__card card-sm">
                        <div class="card-body d-flex align-items-center">
                            <a href="student-take-quiz.html" class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
                                <img src="../../public/images/paths/angular_200x168.png" alt="Angular Fundamentals"
                                    class="avatar-img rounded">
                                <span class="overlay__content"></span>
                            </a>
                            <div class="flex mr-12pt">
...
@section('js_after')
    ...
    <!-- Global Settings -->
    <script src="{{ asset('backend/user/js/settings.js') }}"></script>

    <!-- Flatpickr -->
    <script src="{{ asset('backend/user/vendor/flatpickr/flatpickr.min.js') }}"></script>
    <script src="{{ asset('backend/user/js/flatpickr.js') }}"></script>

    <!-- Moment.js -->
    <script src="{{ asset('backend/user/vendor/moment.min.js') }}"></script>
    <script src="{{ asset('backend/user/vendor/moment-range.js') }}"></script>

    <!-- Chart.js -->
    <script src="{{ asset('backend/user/vendor/Chart.min.js') }}"></script>
    <script src="{{ asset('backend/user/js/chartjs.js') }}"></script>

    <!-- Chart.js Samples -->
    <script src="{{ asset('backend/user/js/page.student-dashboard.js') }}"></script>

    <!-- List.js -->
    <script src="{{ asset('backend/user/vendor/list.min.js') }}"></script>
    <script src="{{ asset('backend/user/js/list.js') }}"></script>

    <!-- Tables -->
    <script src="{{ asset('backend/user/js/toggle-check-all.js') }}"></script>
    <script src="{{ asset('backend/user/js/check-selected-row.js') }}"></script>
