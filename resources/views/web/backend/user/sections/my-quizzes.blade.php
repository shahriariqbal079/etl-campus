                ...
                <div class="card card-group-row__card card-sm">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="flex mr-12pt">
                            <a class="card-title" href="student-take-quiz.html">Angular Routing In-Depth</a>
            ...
            <div class="card-group-row__col col-md-6">
                ...
                <div class="card card-group-row__card card-sm">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="flex mr-12pt">
                            <a class="card-title" href="student-take-quiz.html">Angular Unit Testing</a>
            ...
            <div class="list-group list-group-flush">
                ...
                <div class="list-group-item d-flex flex-column flex-sm-row align-items-sm-center px-12pt">
                    <div class="flex d-flex align-items-center mr-sm-16pt mb-8pt mb-sm-0">
                        <a href="instructor-edit-quiz.html" class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
                            <img src="../../public/images/paths/mailchimp_200x168.png" alt="Newsletter Design"
                                class="avatar-img rounded">
                            <span class="overlay__content"></span>
                        </a>
                        <div class="flex">
                            <a class="card-title" href="instructor-edit-quiz.html">Newsletter Design</a>
                            <div class="card-subtitle text-50">12 min ago</div>
                        </div>
                    </div>
                ...
                <div class="list-group-item d-flex flex-column flex-sm-row align-items-sm-center px-12pt">
                    <div class="flex d-flex align-items-center mr-sm-16pt mb-8pt mb-sm-0">
                        ...
                        <div class="flex">
                            <a class="card-title" href="instructor-edit-quiz.html">Adobe XD</a>
                            <div class="card-subtitle text-50">2 days ago</div>
                        </div>
                    </div>
                    <div class="d-flex flex-column align-items-center mr-16pt">
                ...
                <div class="list-group-item d-flex flex-column flex-sm-row align-items-sm-center px-12pt">
                    <div class="flex d-flex align-items-center mr-sm-16pt mb-8pt mb-sm-0">
                        <a href="instructor-edit-quiz.html" class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
                            <img src="../../public/images/paths/invision_200x168.png" alt="inVision App"
                                class="avatar-img rounded">
                            <span class="overlay__content"></span>
                        </a>
                        <div class="flex">
                            <a class="card-title" href="instructor-edit-quiz.html">inVision App</a>
                            <div class="card-subtitle text-50">3 days ago</div>
                        </div>
                    </div>
                    <div class="d-flex flex-column align-items-center mr-16pt">
                ...
                <div class="list-group-item d-flex flex-column flex-sm-row align-items-sm-center px-12pt">
                    <div class="flex d-flex align-items-center mr-sm-16pt mb-8pt mb-sm-0">
                        <a href="instructor-edit-quiz.html" class="avatar overlay overlay--primary avatar-4by3 mr-12pt">
                            <img src="../../public/images/paths/craft_200x168.png" alt="Craft by inVision"
                                class="avatar-img rounded">
                            <span class="overlay__content"></span>
                        </a>
                        <div class="flex">
                            <a class="card-title" href="instructor-edit-quiz.html">Craft by inVision</a>
                            <div class="card-subtitle text-50">3 days ago</div>
                        </div>
                    </div>
                    <div class="d-flex flex-column align-items-center mr-16pt">
