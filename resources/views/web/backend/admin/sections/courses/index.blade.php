            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-7 col-md-7 col-sm-5 text-sm-right text-center layout-spacing align-self-center">
                    <div class="d-flex justify-content-sm-end justify-content-center">
                        ...
                        <a href="{{ route('admin.course.create') }}" class="btn btn-primary mx-2"> Add Course</a>
                                            ...
                                            <div class="add-contact-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <input type="date"
                                                            class="form-control @error('title') is-invalid @enderror" id=""
                                                            name="admission_start" placeholder="Fee">
                                                        @error('title')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <input type="date"
                                                            class="form-control @error('title') is-invalid @enderror" id=""
                                                            name="admission_close" placeholder="Close">
                                                        @error('title')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                            ...
                            <div class="item-content">
                                <div class="user-profile">
                                    ...
                                    <img height="90" width="90"
                                        src="{{ $course->image ? asset("uploads/images/course/$course->image") : asset('backend/admin/img/90x90.jpg') }}"
                                        alt="avatar">
                                ...
                                <div class="user-email">
                                    ...
                                    <p class="usr-email-addr" data-email="alan@mail.com">
                                        {{ $course->admission_status == 1 ? 'Going' : 'Closed' }}</p>
                                </div>
                                <div class="user-location">
                                ...
                                <div class="user-phone">
                                    ...
                                    <p class="usr-ph-no" data-phone="+1 (070) 123-4567"> {{ $course->duration }} Hours
                                    </p>
                                </div>
                                <div class="action-btn">
